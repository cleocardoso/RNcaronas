...
function calValue(input) { // recebe por parametro o elemento
	...
	showValue(value * parseInt(input.value));// chama a função para exibir o valor
}


// função assíncrono usada para renderizar o usuario no html em forma de tabela
async function render() {
	const url = "/api/usurious" // url para realizar a requisição do recurso que tenha com o nome "Cleo"
